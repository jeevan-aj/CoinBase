...
const Billing = () => (
  <section id='product' className={`${layout.sectionReverse} ${styles.paddingX}`}>
    ...
    <div className={layout.sectionImgReverse}>
      ...
      <div className='absolute top-10 z-[3] -left-3/4 w-[50%] h-[50%] rounded-full pink__gradient'/>
      <div className='absolute bottom-0 z-[0] -left-1/2 w-[50%] h-[50%] rounded-full blue__gradient' />
    </div>
    ...
    <div className={`${layout.sectionInfo} `}>
      ...
      <p className={`${styles.paragraph} text-white mx-w-[470px] mt-5`}>
